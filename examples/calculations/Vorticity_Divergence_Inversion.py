...
upsi,vpsi  = mpcalc.rotational_wind_from_inversion(umask,vmask,vortmask,dx,dy,o_bb_indices,i_bb_indices)
...
uchi,vchi = mpcalc.divergent_wind_from_inversion(umask,vmask,divmask,dx,dy,o_bb_indices,i_bb_indices)
